...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes! We offer free shipping on all orders over Rs.999. For orders under Rs.999, a flat rate of Rs.49 applies. Express and overnight shipping options are also available at checkout.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Currently, we ship across India. We're working on expanding our shipping to international destinations. Sign up for our newsletter to stay updated on when international shipping becomes available.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes! We offer bulk pricing for orders of 20+ items and can arrange custom printing for businesses, events, or teams. Contact us at hello@myotees.in for a custom quote.",
  },
];
  ...
  return (
    <div className="max-w-4xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
      <nav className="flex items-center gap-2 text-sm font-caveat text-warm-500 mb-6">
        ...
        <span>~&gt;</span>
        <span className="text-warm-900">FAQ</span>
      </nav>
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-warm-500 max-w-2xl mx-auto">
          ...
          feel free to <Link href="/contact" className="text-primary-600 hover:underline">contact us</Link>.
        </p>
      </div>
      ...
      <div className="space-y-3">
        {faqs.map((faq, index) => (
          <div
            key={index}
            className={`sketchy-border-light overflow-hidden transition-shadow hover:shadow-sm ${
              openIndex === index ? "bg-warm-50" : ""
            }`}
          >
            <button
            ...
            >
              <span className="font-medium text-warm-900 pr-4">{faq.question}</span>
              <ChevronDown
                size={20}
                className={`text-warm-400 flex-shrink-0 transition-transform duration-200 ${
      ...
      <div className="mt-16 text-center bg-primary-50 sketchy-border-light p-10">
        <h2 className="text-2xl font-marker text-warm-900 mb-3">Still have questions?</h2>
        <p className="text-warm-500 mb-6">We&apos;re here to help. Reach out to our team anytime.</p>
        <Link
          href="/contact"
