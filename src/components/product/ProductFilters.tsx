    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none"
        >
          {sortOptions.map((opt) => (
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden flex items-center gap-2 px-4 py-2.5 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition mb-4"
      >
